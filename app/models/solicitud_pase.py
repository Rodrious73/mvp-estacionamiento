...
class SolicitudPase(db.Model):
    ...
    comentarios_solicitante = db.Column(db.String(255), nullable=True)
    ...
    def __init__(self, usuario_id, vehiculo_id, tipo_pase, ciclo_id=None, comentarios_solicitante=None):
        self.usuario_id = usuario_id
        self.vehiculo_id = vehiculo_id
        self.ciclo_id = ciclo_id
        self.tipo_pase = tipo_pase
        self.comentarios_solicitante = comentarios_solicitante
    ...
    def to_dict(self):
        ...
        return {
            ...
            'comentarios_solicitante': self.comentarios_solicitante,
